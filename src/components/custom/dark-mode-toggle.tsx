	...
	return (
		<>
			<div class="container mx-auto">
				<form class="flex justify-center my-10">
					<label
						for="toggle"
						class="cursor-pointer bg-slate-100 dark:bg-navy-900 rounded-md shadow-md dark:shadow-lg dark:shadow-navy-700 p-4"
					>
						<input
							type="checkbox"
							id="toggle"
						...
						<svg
							id="toggle-label"
							class={`fill-current w-6 h-6 ${isDark.value ? "" : "hidden"}`}
